...
Address: Mokopane, Limpopo, 0601`,
  ...
  // Admin Login
  adminLoginHeroImage: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=2000',
  adminLoginAccentEnabled: true,
  adminLoginHeroBadge: 'Command Center',
  adminLoginHeroTitle: 'Maison Portal',
  adminLoginHeroDescription: 'Administrative Control Panel',
  adminLoginEmailLabel: 'Admin Email',
  adminLoginPasswordLabel: 'Password',
  adminLoginEmailPlaceholder: 'admin@maisonportal.com',
  adminLoginPasswordPlaceholder: '••••••••',
  ...
  // Client Login
  clientLoginHeroBadge: 'Exclusive Access',
  clientLoginHeroTitle: 'Welcome Back',
  clientLoginHeroDescription: 'Join our community of fashion enthusiasts. Track your orders, manage your preferences, and stay updated with our latest collections.',
  clientLoginEmailLabel: 'Email Address',
  clientLoginPasswordLabel: 'Password',
  clientLoginEmailPlaceholder: 'your@email.com',
  clientLoginPasswordPlaceholder: '••••••••',
  clientLoginSubmitLabel: 'Sign In',
  ...
  clientLoginSuccessTitleSuffix: '!',
  clientLoginSuccessMessage: 'You have successfully signed in to your account.',
  clientLoginSecurityLabel: 'Secure Environment',
  clientLoginDividerLabel: 'OR',
