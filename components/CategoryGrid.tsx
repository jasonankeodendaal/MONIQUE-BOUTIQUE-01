          ...
          {displayItems.map((cat, idx) => (
            ...
            >
              ...
              <div className="absolute inset-0 p-4 md:p-12 flex flex-col justify-end items-start text-left z-10">
                <div className="w-8 h-8 md:w-16 md:h-16 bg-white/20 backdrop-blur-md rounded-xl md:rounded-2xl flex items-center justify-center text-white mb-3 md:mb-6 border border-white/20 transform -translate-y-2 md:-translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700 shadow-2xl">
                ...
                <p className="text-[8px] md:text-base text-white/70 leading-relaxed font-light mb-4 md:mb-8 max-h-0 overflow-hidden group-hover:max-h-32 transition-all duration-1000 ease-in-out opacity-0 group-hover:opacity-100 pr-2 md:pr-4 line-clamp-3 transform translate-y-2 md:translate-y-4 group-hover:translate-y-0">
                  {cat.description}
                </p>
