...
const newConstantsContent = constantsContent.substring(0, startIndex) + newCodeBlock + constantsContent.substring(endIndex + "FOR EACH ROW EXECUTE FUNCTION public.handle_new_user();\n`".length);
