...
CREATE TABLE IF NOT EXISTS settings (
  ...
  "adminLoginSubmitLabel" TEXT, "adminLoginSubmittingLabel" TEXT, "adminLoginGoogleLabel" TEXT, "adminLoginBackToSite" TEXT,
  ...
  "clientLoginSuccessMessage" TEXT, "clientLoginSecurityLabel" TEXT, "clientLoginDividerLabel" TEXT,
