...
const ProductDetail: React.FC = () => {
  ...
  return (
    <main className={`min-h-screen bg-[#FDFCFB] transition-opacity duration-1000 pt-0 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      {/* Global Persistent Back Button (Viewport Level) */}
      <button 
      ...
      <div className="flex flex-col lg:flex-row min-h-screen lg:h-screen lg:overflow-hidden">
        ...
        <div className="w-full lg:w-3/5 h-[60vh] md:h-[70vh] lg:h-full relative overflow-hidden group">
          ...
          {/* Contextual Back Button (Requested Placement) */}
          <div className="absolute top-6 left-6 md:top-12 md:left-12 z-30 pointer-events-auto">
            <button 
                onClick={() => navigate('/products')}
                className="hidden lg:flex items-center gap-3 px-6 py-4 bg-white/40 backdrop-blur-md border border-primary/20 rounded-2xl text-slate-900 hover:bg-white transition-all shadow-xl group/back"
            >
