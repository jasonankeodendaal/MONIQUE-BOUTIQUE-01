      ...
      <div className="w-full max-w-4xl">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative group">
                        ...
                        <input 
                          ...
                          className="w-full pl-12 pr-4 py-4 bg-slate-950/50 border border-slate-800 rounded-xl text-white outline-none focus:border-primary focus:bg-slate-950 transition-all placeholder:text-slate-700 text-sm"
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative group flex">
                        ...
                        <input 
                          ...
                          onChange={handleChange}
                          className="w-full px-4 py-4 bg-slate-950/50 border border-slate-800 rounded-r-xl text-white outline-none focus:border-primary focus:bg-slate-950 transition-all placeholder:text-slate-700 text-sm"
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative group">
                        ...
                        <input 
                          ...
                          onChange={handleChange}
                          className="w-full pl-12 pr-12 py-4 bg-slate-950/50 border border-slate-800 rounded-xl text-white outline-none focus:border-primary focus:bg-slate-950 transition-all placeholder:text-slate-700 text-sm"
                          placeholder="••••••••"
                        />
                        <button 
                          type="button"
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative group">
                        <select 
                          ...
                          onChange={handleChange}
                          className="w-full px-4 py-4 bg-slate-950/50 border border-slate-800 rounded-xl text-white outline-none focus:border-primary focus:bg-slate-950 transition-all text-sm appearance-none"
                        >
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-6 bg-slate-950/50 border border-slate-800 rounded-2xl space-y-4">
                    ...
                    <div className="flex items-center gap-6">
                      <div className="text-2xl font-serif text-white italic tracking-widest bg-slate-900 px-4 py-2 rounded-lg border border-slate-800">
                      ...
                      <input 
                        ...
                        className="w-24 px-4 py-3 bg-slate-900 border border-slate-800 rounded-xl text-white outline-none focus:border-primary transition-all text-center text-lg font-bold"
                        placeholder="?"
                      />
                    </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-slate-600 text-[10px] uppercase tracking-[0.4em]">
            Secure Registration Protocol • v3.4.0
          </p>
        </div>
      </div>
    </div>
